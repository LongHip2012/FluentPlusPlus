...
github.com/LongHip2012/FluentPlus | discord.gg/dBmXyaJhuK
...
local Themes = {
    ...
    Darker = {
        ...
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(25, 25, 25), Color3.fromRGB(25, 25, 25)),
        AcrylicNoise = 0.9,
    ...
    Light = {
        Name = "Light",
        Accent = Color3.fromRGB(0, 122, 255),
        AcrylicMain = Color3.fromRGB(230, 230, 230),
        AcrylicBorder = Color3.fromRGB(200, 200, 200),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(230, 230, 230), Color3.fromRGB(230, 230, 230)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(190, 190, 190),
        ...
        Keybind = Color3.fromRGB(210, 210, 210),
        ...
        DialogButton = Color3.fromRGB(220, 220, 220),
    ...
    Balloon = {
        ...
        AcrylicBorder = Color3.fromRGB(200, 200, 200),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(240, 240, 245), Color3.fromRGB(240, 240, 245)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(190, 190, 190),
        Tab = Color3.fromRGB(100, 100, 100),
        ...
        InElementBorder = Color3.fromRGB(200, 200, 200),
        ElementTransparency = 0.85,
        ToggleSlider = Color3.fromRGB(255, 182, 193),
        ToggleToggled = Color3.fromRGB(255, 255, 255),
        SliderRail = Color3.fromRGB(255, 182, 193),
        DropdownFrame = Color3.fromRGB(245, 245, 250),
        DropdownHolder = Color3.fromRGB(230, 230, 235),
        DropdownBorder = Color3.fromRGB(180, 180, 180),
        DropdownOption = Color3.fromRGB(100, 100, 100),
        ...
        InputFocused = Color3.fromRGB(255, 255, 255),
        InputIndicator = Color3.fromRGB(150, 150, 150),
        Dialog = Color3.fromRGB(230, 230, 235),
        DialogHolder = Color3.fromRGB(220, 220, 225),
        DialogHolderLine = Color3.fromRGB(200, 200, 200),
        DialogButton = Color3.fromRGB(230, 230, 235),
        DialogButtonBorder = Color3.fromRGB(190, 190, 190),
        DialogBorder = Color3.fromRGB(200, 200, 200),
        DialogInput = Color3.fromRGB(245, 245, 250),
        DialogInputLine = Color3.fromRGB(255, 182, 193),
        Text = Color3.fromRGB(80, 80, 80),
        SubText = Color3.fromRGB(140, 140, 140),
        Hover = Color3.fromRGB(210, 210, 215),
        HoverChange = 0.05
    },
    SoftCream = {
        Name = "SoftCream",
        Accent = Color3.fromRGB(255, 222, 173),
        AcrylicMain = Color3.fromRGB(245, 245, 220),
        AcrylicBorder = Color3.fromRGB(210, 210, 210),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(245, 245, 220), Color3.fromRGB(245, 245, 220)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(200, 200, 200),
        Tab = Color3.fromRGB(80, 80, 80),
        Element = Color3.fromRGB(230, 230, 210),
        ElementBorder = Color3.fromRGB(190, 190, 190),
        InElementBorder = Color3.fromRGB(210, 210, 210),
        ElementTransparency = 0.85,
        ToggleSlider = Color3.fromRGB(255, 222, 173),
        ToggleToggled = Color3.fromRGB(255, 255, 255),
        SliderRail = Color3.fromRGB(255, 222, 173),
        DropdownFrame = Color3.fromRGB(250, 250, 230),
        DropdownHolder = Color3.fromRGB(235, 235, 215),
        DropdownBorder = Color3.fromRGB(190, 190, 190),
        DropdownOption = Color3.fromRGB(80, 80, 80),
        Keybind = Color3.fromRGB(230, 230, 210),
        Input = Color3.fromRGB(250, 250, 230),
        InputFocused = Color3.fromRGB(255, 255, 255),
        InputIndicator = Color3.fromRGB(130, 130, 130),
        Dialog = Color3.fromRGB(235, 235, 215),
        DialogHolder = Color3.fromRGB(230, 230, 210),
        DialogHolderLine = Color3.fromRGB(210, 210, 210),
        DialogButton = Color3.fromRGB(235, 235, 215),
        DialogButtonBorder = Color3.fromRGB(200, 200, 200),
        DialogBorder = Color3.fromRGB(210, 210, 210),
        DialogInput = Color3.fromRGB(250, 250, 230),
        DialogInputLine = Color3.fromRGB(255, 222, 173),
        Text = Color3.fromRGB(70, 70, 70),
        SubText = Color3.fromRGB(130, 130, 130),
        Hover = Color3.fromRGB(220, 220, 200),
        HoverChange = 0.05
    },
    Aqua = {
        Name = "Aqua",
        Accent = Color3.fromRGB(0, 255, 255),
        AcrylicMain = Color3.fromRGB(40, 80, 100),
        AcrylicBorder = Color3.fromRGB(70, 100, 120),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 80, 100), Color3.fromRGB(40, 80, 100)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(60, 90, 110),
        Tab = Color3.fromRGB(150, 150, 150),
        Element = Color3.fromRGB(80, 120, 140),
        ElementBorder = Color3.fromRGB(50, 80, 100),
        InElementBorder = Color3.fromRGB(70, 100, 120),
        ElementTransparency = 0.87,
        ToggleSlider = Color3.fromRGB(0, 255, 255),
        ToggleToggled = Color3.fromRGB(30, 60, 80),
        SliderRail = Color3.fromRGB(0, 255, 255),
        DropdownFrame = Color3.fromRGB(100, 140, 160),
        DropdownHolder = Color3.fromRGB(50, 90, 110),
        DropdownBorder = Color3.fromRGB(50, 80, 100),
        DropdownOption = Color3.fromRGB(150, 150, 150),
        Keybind = Color3.fromRGB(80, 120, 140),
        Input = Color3.fromRGB(100, 140, 160),
        InputFocused = Color3.fromRGB(20, 50, 70),
        InputIndicator = Color3.fromRGB(120, 160, 180),
        Dialog = Color3.fromRGB(50, 90, 110),
        DialogHolder = Color3.fromRGB(40, 80, 100),
        DialogHolderLine = Color3.fromRGB(30, 70, 90),
        DialogButton = Color3.fromRGB(50, 90, 110),
        DialogButtonBorder = Color3.fromRGB(60, 100, 120),
        DialogBorder = Color3.fromRGB(60, 90, 110),
        DialogInput = Color3.fromRGB(60, 100, 120),
        DialogInputLine = Color3.fromRGB(100, 140, 160),
        Text = Color3.fromRGB(200, 200, 200),
        SubText = Color3.fromRGB(150, 150, 150),
        Hover = Color3.fromRGB(80, 120, 140),
        HoverChange = 0.07
    },
    Amethyst = {
        Name = "Amethyst",
        Accent = Color3.fromRGB(153, 102, 204),
        AcrylicMain = Color3.fromRGB(50, 40, 60),
        AcrylicBorder = Color3.fromRGB(80, 70, 90),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(50, 40, 60), Color3.fromRGB(50, 40, 60)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(70, 60, 80),
        Tab = Color3.fromRGB(120, 110, 130),
        Element = Color3.fromRGB(90, 80, 100),
        ElementBorder = Color3.fromRGB(40, 30, 50),
        InElementBorder = Color3.fromRGB(80, 70, 90),
        ElementTransparency = 0.88,
        ToggleSlider = Color3.fromRGB(153, 102, 204),
        ToggleToggled = Color3.fromRGB(40, 30, 50),
        SliderRail = Color3.fromRGB(153, 102, 204),
        DropdownFrame = Color3.fromRGB(110, 100, 120),
        DropdownHolder = Color3.fromRGB(60, 50, 70),
        DropdownBorder = Color3.fromRGB(40, 30, 50),
        DropdownOption = Color3.fromRGB(120, 110, 130),
        Keybind = Color3.fromRGB(90, 80, 100),
        Input = Color3.fromRGB(110, 100, 120),
        InputFocused = Color3.fromRGB(30, 20, 40),
        InputIndicator = Color3.fromRGB(130, 120, 140),
        Dialog = Color3.fromRGB(60, 50, 70),
        DialogHolder = Color3.fromRGB(50, 40, 60),
        DialogHolderLine = Color3.fromRGB(40, 30, 50),
        DialogButton = Color3.fromRGB(60, 50, 70),
        DialogButtonBorder = Color3.fromRGB(70, 60, 80),
        DialogBorder = Color3.fromRGB(70, 60, 80),
        DialogInput = Color3.fromRGB(70, 60, 80),
        DialogInputLine = Color3.fromRGB(110, 100, 120),
        Text = Color3.fromRGB(220, 220, 220),
        SubText = Color3.fromRGB(160, 160, 160),
        Hover = Color3.fromRGB(90, 80, 100),
        HoverChange = 0.08
    },
    Rose = {
        Name = "Rose",
        Accent = Color3.fromRGB(255, 105, 180),
        AcrylicMain = Color3.fromRGB(60, 40, 50),
        AcrylicBorder = Color3.fromRGB(90, 70, 80),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(60, 40, 50), Color3.fromRGB(60, 40, 50)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(80, 60, 70),
        Tab = Color3.fromRGB(130, 110, 120),
        Element = Color3.fromRGB(100, 80, 90),
        ElementBorder = Color3.fromRGB(50, 30, 40),
        InElementBorder = Color3.fromRGB(90, 70, 80),
        ElementTransparency = 0.88,
        ToggleSlider = Color3.fromRGB(255, 105, 180),
        ToggleToggled = Color3.fromRGB(50, 30, 40),
        SliderRail = Color3.fromRGB(255, 105, 180),
        DropdownFrame = Color3.fromRGB(120, 100, 110),
        DropdownHolder = Color3.fromRGB(70, 50, 60),
        DropdownBorder = Color3.fromRGB(50, 30, 40),
        DropdownOption = Color3.fromRGB(130, 110, 120),
        Keybind = Color3.fromRGB(100, 80, 90),
        Input = Color3.fromRGB(120, 100, 110),
        InputFocused = Color3.fromRGB(40, 20, 30),
        InputIndicator = Color3.fromRGB(140, 120, 130),
        Dialog = Color3.fromRGB(70, 50, 60),
        DialogHolder = Color3.fromRGB(60, 40, 50),
        DialogHolderLine = Color3.fromRGB(50, 30, 40),
        DialogButton = Color3.fromRGB(70, 50, 60),
        DialogButtonBorder = Color3.fromRGB(80, 60, 70),
        DialogBorder = Color3.fromRGB(80, 60, 70),
        DialogInput = Color3.fromRGB(80, 60, 70),
        DialogInputLine = Color3.fromRGB(120, 100, 110),
        Text = Color3.fromRGB(220, 220, 220),
        SubText = Color3.fromRGB(160, 160, 160),
        Hover = Color3.fromRGB(100, 80, 90),
        HoverChange = 0.08
    },
    Midnight = {
        Name = "Midnight",
        Accent = Color3.fromRGB(75, 0, 130),
        AcrylicMain = Color3.fromRGB(30, 30, 50),
        AcrylicBorder = Color3.fromRGB(60, 60, 80),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 30, 50), Color3.fromRGB(30, 30, 50)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(50, 50, 70),
        Tab = Color3.fromRGB(100, 100, 120),
        Element = Color3.fromRGB(70, 70, 90),
        ElementBorder = Color3.fromRGB(40, 40, 60),
        InElementBorder = Color3.fromRGB(60, 60, 80),
        ElementTransparency = 0.89,
        ToggleSlider = Color3.fromRGB(75, 0, 130),
        ToggleToggled = Color3.fromRGB(20, 20, 40),
        SliderRail = Color3.fromRGB(75, 0, 130),
        DropdownFrame = Color3.fromRGB(90, 90, 110),
        DropdownHolder = Color3.fromRGB(50, 50, 70),
        DropdownBorder = Color3.fromRGB(40, 40, 60),
        DropdownOption = Color3.fromRGB(100, 100, 120),
        Keybind = Color3.fromRGB(70, 70, 90),
        Input = Color3.fromRGB(90, 90, 110),
        InputFocused = Color3.fromRGB(20, 20, 40),
        InputIndicator = Color3.fromRGB(110, 110, 130),
        Dialog = Color3.fromRGB(50, 50, 70),
        DialogHolder = Color3.fromRGB(30, 30, 50),
        DialogHolderLine = Color3.fromRGB(40, 40, 60),
        DialogButton = Color3.fromRGB(50, 50, 70),
        DialogButtonBorder = Color3.fromRGB(60, 60, 80),
        DialogBorder = Color3.fromRGB(60, 60, 80),
        DialogInput = Color3.fromRGB(60, 60, 80),
        DialogInputLine = Color3.fromRGB(90, 90, 110),
    ...
    Forest = {
        ...
        AcrylicMain = Color3.fromRGB(40, 50, 40),
        AcrylicBorder = Color3.fromRGB(70, 80, 70),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 50, 40), Color3.fromRGB(40, 50, 40)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(60, 70, 60),
        Tab = Color3.fromRGB(120, 130, 120),
        Element = Color3.fromRGB(80, 90, 80),
        ElementBorder = Color3.fromRGB(50, 60, 50),
        InElementBorder = Color3.fromRGB(70, 80, 70),
        ElementTransparency = 0.88,
        ToggleSlider = Color3.fromRGB(34, 139, 34),
        ToggleToggled = Color3.fromRGB(30, 40, 30),
        SliderRail = Color3.fromRGB(34, 139, 34),
        DropdownFrame = Color3.fromRGB(100, 110, 100),
        DropdownHolder = Color3.fromRGB(60, 70, 60),
        DropdownBorder = Color3.fromRGB(50, 60, 50),
        DropdownOption = Color3.fromRGB(120, 130, 120),
        Keybind = Color3.fromRGB(80, 90, 80),
        Input = Color3.fromRGB(100, 110, 100),
        InputFocused = Color3.fromRGB(30, 40, 30),
        InputIndicator = Color3.fromRGB(120, 130, 120),
        Dialog = Color3.fromRGB(60, 70, 60),
        DialogHolder = Color3.fromRGB(40, 50, 40),
        DialogHolderLine = Color3.fromRGB(50, 60, 50),
        DialogButton = Color3.fromRGB(60, 70, 60),
        DialogButtonBorder = Color3.fromRGB(70, 80, 70),
        DialogBorder = Color3.fromRGB(70, 80, 70),
        DialogInput = Color3.fromRGB(70, 80, 70),
        DialogInputLine = Color3.fromRGB(100, 110, 100),
        Text = Color3.fromRGB(200, 210, 200),
        SubText = Color3.fromRGB(140, 150, 140),
        Hover = Color3.fromRGB(80, 90, 80),
        HoverChange = 0.08
    },
    Sunset = {
        Name = "Sunset",
        Accent = Color3.fromRGB(255, 69, 0),
        AcrylicMain = Color3.fromRGB(60, 40, 30),
        AcrylicBorder = Color3.fromRGB(90, 70, 60),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(60, 40, 30), Color3.fromRGB(60, 40, 30)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(80, 60, 50),
        Tab = Color3.fromRGB(130, 110, 100),
        Element = Color3.fromRGB(100, 80, 70),
        ElementBorder = Color3.fromRGB(50, 40, 30),
        InElementBorder = Color3.fromRGB(90, 70, 60),
        ElementTransparency = 0.88,
        ToggleSlider = Color3.fromRGB(255, 69, 0),
        ToggleToggled = Color3.fromRGB(50, 30, 20),
        SliderRail = Color3.fromRGB(255, 69, 0),
        DropdownFrame = Color3.fromRGB(120, 100, 90),
        DropdownHolder = Color3.fromRGB(70, 50, 40),
        DropdownBorder = Color3.fromRGB(50, 40, 30),
        DropdownOption = Color3.fromRGB(130, 110, 100),
        Keybind = Color3.fromRGB(100, 80, 70),
        Input = Color3.fromRGB(120, 100, 90),
        InputFocused = Color3.fromRGB(40, 30, 20),
        InputIndicator = Color3.fromRGB(140, 120, 110),
        Dialog = Color3.fromRGB(70, 50, 40),
        DialogHolder = Color3.fromRGB(60, 40, 30),
        DialogHolderLine = Color3.fromRGB(50, 40, 30),
        DialogButton = Color3.fromRGB(70, 50, 40),
        DialogButtonBorder = Color3.fromRGB(80, 60, 50),
        DialogBorder = Color3.fromRGB(80, 60, 50),
        DialogInput = Color3.fromRGB(80, 60, 50),
        DialogInputLine = Color3.fromRGB(120, 100, 90),
        Text = Color3.fromRGB(220, 200, 190),
        SubText = Color3.fromRGB(160, 140, 130),
        Hover = Color3.fromRGB(100, 80, 70),
        HoverChange = 0.08
    },
    Ocean = {
        Name = "Ocean",
        Accent = Color3.fromRGB(0, 105, 148),
        AcrylicMain = Color3.fromRGB(30, 50, 70),
        AcrylicBorder = Color3.fromRGB(60, 80, 100),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 50, 70), Color3.fromRGB(30, 50, 70)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(50, 70, 90),
        Tab = Color3.fromRGB(110, 130, 150),
        Element = Color3.fromRGB(70, 90, 110),
        ElementBorder = Color3.fromRGB(40, 60, 80),
        InElementBorder = Color3.fromRGB(60, 80, 100),
        ElementTransparency = 0.88,
        ToggleSlider = Color3.fromRGB(0, 105, 148),
        ToggleToggled = Color3.fromRGB(20, 40, 60),
        SliderRail = Color3.fromRGB(0, 105, 148),
        DropdownFrame = Color3.fromRGB(90, 110, 130),
        DropdownHolder = Color3.fromRGB(50, 70, 90),
        DropdownBorder = Color3.fromRGB(40, 60, 80),
        DropdownOption = Color3.fromRGB(110, 130, 150),
        Keybind = Color3.fromRGB(70, 90, 110),
        Input = Color3.fromRGB(90, 110, 130),
        InputFocused = Color3.fromRGB(20, 40, 60),
        InputIndicator = Color3.fromRGB(110, 130, 150),
        Dialog = Color3.fromRGB(50, 70, 90),
        DialogHolder = Color3.fromRGB(30, 50, 70),
        DialogHolderLine = Color3.fromRGB(40, 60, 80),
        DialogButton = Color3.fromRGB(50, 70, 90),
        DialogButtonBorder = Color3.fromRGB(60, 80, 100),
        DialogBorder = Color3.fromRGB(60, 80, 100),
        DialogInput = Color3.fromRGB(60, 80, 100),
        DialogInputLine = Color3.fromRGB(90, 110, 130),
        Text = Color3.fromRGB(200, 220, 240),
        SubText = Color3.fromRGB(140, 160, 180),
        Hover = Color3.fromRGB(70, 90, 110),
        HoverChange = 0.08
    },
    Emerald = {
        Name = "Emerald",
        Accent = Color3.fromRGB(0, 201, 87),
        AcrylicMain = Color3.fromRGB(40, 60, 50),
        AcrylicBorder = Color3.fromRGB(70, 90, 80),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 60, 50), Color3.fromRGB(40, 60, 50)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(60, 80, 70),
        Tab = Color3.fromRGB(120, 140, 130),
        Element = Color3.fromRGB(80, 100, 90),
        ElementBorder = Color3.fromRGB(50, 70, 60),
        InElementBorder = Color3.fromRGB(70, 90, 80),
        ElementTransparency = 0.88,
        ToggleSlider = Color3.fromRGB(0, 201, 87),
        ToggleToggled = Color3.fromRGB(30, 50, 40),
        SliderRail = Color3.fromRGB(0, 201, 87),
        DropdownFrame = Color3.fromRGB(100, 120, 110),
        DropdownHolder = Color3.fromRGB(60, 80, 70),
        DropdownBorder = Color3.fromRGB(50, 70, 60),
        DropdownOption = Color3.fromRGB(120, 140, 130),
        Keybind = Color3.fromRGB(80, 100, 90),
        Input = Color3.fromRGB(100, 120, 110),
        InputFocused = Color3.fromRGB(30, 50, 40),
        InputIndicator = Color3.fromRGB(120, 140, 130),
        Dialog = Color3.fromRGB(60, 80, 70),
        DialogHolder = Color3.fromRGB(40, 60, 50),
        DialogHolderLine = Color3.fromRGB(50, 70, 60),
        DialogButton = Color3.fromRGB(60, 80, 70),
        DialogButtonBorder = Color3.fromRGB(70, 90, 80),
        DialogBorder = Color3.fromRGB(70, 90, 80),
        DialogInput = Color3.fromRGB(70, 90, 80),
        DialogInputLine = Color3.fromRGB(100, 120, 110),
        Text = Color3.fromRGB(200, 220, 210),
        SubText = Color3.fromRGB(140, 160, 150),
        Hover = Color3.fromRGB(80, 100, 90),
        HoverChange = 0.08
    },
    Sapphire = {
        Name = "Sapphire",
        Accent = Color3.fromRGB(0, 71, 171),
        AcrylicMain = Color3.fromRGB(30, 40, 60),
        AcrylicBorder = Color3.fromRGB(60, 70, 90),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 40, 60), Color3.fromRGB(30, 40, 60)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(50, 60, 80),
        Tab = Color3.fromRGB(110, 120, 140),
        Element = Color3.fromRGB(70, 80, 100),
        ElementBorder = Color3.fromRGB(40, 50, 70),
        InElementBorder = Color3.fromRGB(60, 70, 90),
        ElementTransparency = 0.88,
        ToggleSlider = Color3.fromRGB(0, 71, 171),
        ToggleToggled = Color3.fromRGB(20, 30, 50),
        SliderRail = Color3.fromRGB(0, 71, 171),
        DropdownFrame = Color3.fromRGB(90, 100, 120),
        DropdownHolder = Color3.fromRGB(50, 60, 80),
        DropdownBorder = Color3.fromRGB(40, 50, 70),
        DropdownOption = Color3.fromRGB(110, 120, 140),
        Keybind = Color3.fromRGB(70, 80, 100),
        Input = Color3.fromRGB(90, 100, 120),
        InputFocused = Color3.fromRGB(20, 30, 50),
        InputIndicator = Color3.fromRGB(110, 120, 140),
        Dialog = Color3.fromRGB(50, 60, 80),
        DialogHolder = Color3.fromRGB(30, 40, 60),
        DialogHolderLine = Color3.fromRGB(40, 50, 70),
        DialogButton = Color3.fromRGB(50, 60, 80),
        DialogButtonBorder = Color3.fromRGB(60, 70, 90),
        DialogBorder = Color3.fromRGB(60, 70, 90),
        DialogInput = Color3.fromRGB(60, 70, 90),
        DialogInputLine = Color3.fromRGB(90, 100, 120),
        Text = Color3.fromRGB(200, 210, 230),
        SubText = Color3.fromRGB(140, 150, 170),
        Hover = Color3.fromRGB(70, 80, 100),
        HoverChange = 0.08
    },
    Cloud = {
        Name = "Cloud",
        ...
        AcrylicBorder = Color3.fromRGB(200, 210, 215),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(230, 240, 245), Color3.fromRGB(230, 240, 245)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(190, 200, 205),
        Tab = Color3.fromRGB(60, 70, 80),
        Element = Color3.fromRGB(210, 220, 225),
        ElementBorder = Color3.fromRGB(180, 190, 195),
        InElementBorder = Color3.fromRGB(200, 210, 215),
        ElementTransparency = 0.85,
        ToggleSlider = Color3.fromRGB(135, 206, 250),
        ToggleToggled = Color3.fromRGB(255, 255, 255),
        SliderRail = Color3.fromRGB(135, 206, 250),
        DropdownFrame = Color3.fromRGB(240, 245, 250),
        DropdownHolder = Color3.fromRGB(220, 230, 235),
        DropdownBorder = Color3.fromRGB(180, 190, 195),
        DropdownOption = Color3.fromRGB(60, 70, 80),
        Keybind = Color3.fromRGB(210, 220, 225),
        Input = Color3.fromRGB(240, 245, 250),
        InputFocused = Color3.fromRGB(255, 255, 255),
        InputIndicator = Color3.fromRGB(130, 140, 150),
        Dialog = Color3.fromRGB(220, 230, 235),
        DialogHolder = Color3.fromRGB(210, 220, 225),
        DialogHolderLine = Color3.fromRGB(200, 210, 215),
        DialogButton = Color3.fromRGB(220, 230, 235),
        DialogButtonBorder = Color3.fromRGB(190, 200, 205),
        DialogBorder = Color3.fromRGB(200, 210, 215),
        DialogInput = Color3.fromRGB(240, 245, 250),
        DialogInputLine = Color3.fromRGB(135, 206, 250),
        Text = Color3.fromRGB(60, 70, 80),
        SubText = Color3.fromRGB(130, 140, 150),
        Hover = Color3.fromRGB(200, 210, 215),
        HoverChange = 0.05
    },
    Grape = {
        Name = "Grape",
        ...
        ToggleToggled = Color3.fromRGB(40, 30, 50),
        SliderRail = Color3.fromRGB(138, 43, 226),
        DropdownFrame = Color3.fromRGB(110, 100, 120),
        DropdownHolder = Color3.fromRGB(60, 50, 70),
        DropdownBorder = Color3.fromRGB(40, 30, 50),
        DropdownOption = Color3.fromRGB(120, 110, 130),
    ...
    Bloody = {
        ...
        AcrylicMain = Color3.fromRGB(50, 30, 30),
        AcrylicBorder = Color3.fromRGB(80, 60, 60),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(50, 30, 30), Color3.fromRGB(50, 30, 30)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(70, 50, 50),
        Tab = Color3.fromRGB(120, 100, 100),
        Element = Color3.fromRGB(90, 70, 70),
        ElementBorder = Color3.fromRGB(40, 20, 20),
        InElementBorder = Color3.fromRGB(80, 60, 60),
        ElementTransparency = 0.88,
        ToggleSlider = Color3.fromRGB(255, 0, 0),
        ToggleToggled = Color3.fromRGB(40, 20, 20),
        SliderRail = Color3.fromRGB(255, 0, 0),
        DropdownFrame = Color3.fromRGB(110, 90, 90),
        DropdownHolder = Color3.fromRGB(60, 40, 40),
        DropdownBorder = Color3.fromRGB(40, 20, 20),
        DropdownOption = Color3.fromRGB(120, 100, 100),
        Keybind = Color3.fromRGB(90, 70, 70),
        Input = Color3.fromRGB(110, 90, 90),
        InputFocused = Color3.fromRGB(30, 10, 10),
        InputIndicator = Color3.fromRGB(130, 110, 110),
        Dialog = Color3.fromRGB(60, 40, 40),
        DialogHolder = Color3.fromRGB(50, 30, 30),
        DialogHolderLine = Color3.fromRGB(40, 20, 20),
        DialogButton = Color3.fromRGB(60, 40, 40),
        DialogButtonBorder = Color3.fromRGB(70, 50, 50),
        DialogBorder = Color3.fromRGB(70, 50, 50),
        DialogInput = Color3.fromRGB(70, 50, 50),
        DialogInputLine = Color3.fromRGB(110, 90, 90),
        Text = Color3.fromRGB(220, 200, 200),
        SubText = Color3.fromRGB(160, 140, 140),
        Hover = Color3.fromRGB(90, 70, 70),
        HoverChange = 0.08
    },
    Arctic = {
        Name = "Arctic",
        Accent = Color3.fromRGB(173, 216, 230),
        AcrylicMain = Color3.fromRGB(240, 245, 250),
        AcrylicBorder = Color3.fromRGB(200, 210, 220),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(240, 245, 250), Color3.fromRGB(240, 245, 250)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(190, 200, 210),
        Tab = Color3.fromRGB(50, 60, 70),
        Element = Color3.fromRGB(220, 230, 240),
        ElementBorder = Color3.fromRGB(180, 190, 200),
        InElementBorder = Color3.fromRGB(200, 210, 220),
        ElementTransparency = 0.85,
        ToggleSlider = Color3.fromRGB(173, 216, 230),
        ToggleToggled = Color3.fromRGB(255, 255, 255),
        SliderRail = Color3.fromRGB(173, 216, 230),
        DropdownFrame = Color3.fromRGB(245, 250, 255),
        DropdownHolder = Color3.fromRGB(230, 235, 240),
        DropdownBorder = Color3.fromRGB(180, 190, 200),
        DropdownOption = Color3.fromRGB(50, 60, 70),
        Keybind = Color3.fromRGB(220, 230, 240),
        Input = Color3.fromRGB(245, 250, 255),
        InputFocused = Color3.fromRGB(255, 255, 255),
        InputIndicator = Color3.fromRGB(130, 140, 150),
        Dialog = Color3.fromRGB(230, 235, 240),
        DialogHolder = Color3.fromRGB(220, 230, 240),
        DialogHolderLine = Color3.fromRGB(200, 210, 220),
        DialogButton = Color3.fromRGB(230, 235, 240),
        DialogButtonBorder = Color3.fromRGB(190, 200, 210),
        DialogBorder = Color3.fromRGB(200, 210, 220),
        DialogInput = Color3.fromRGB(245, 250, 255),
        DialogInputLine = Color3.fromRGB(173, 216, 230),
        Text = Color3.fromRGB(50, 60, 70),
        SubText = Color3.fromRGB(130, 140, 150),
        Hover = Color3.fromRGB(210, 220, 230),
        HoverChange = 0.05
    },
    ["GitHub Dark Dimmed"] = {
        Name = "GitHub Dark Dimmed",
        Accent = Color3.fromRGB(88, 166, 255),
        AcrylicMain = Color3.fromRGB(33, 38, 44),
        AcrylicBorder = Color3.fromRGB(48, 54, 61),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(33, 38, 44), Color3.fromRGB(33, 38, 44)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(45, 50, 56),
        Tab = Color3.fromRGB(139, 148, 158),
        Element = Color3.fromRGB(45, 50, 56),
        ElementBorder = Color3.fromRGB(30, 35, 40),
        InElementBorder = Color3.fromRGB(48, 54, 61),
        ElementTransparency = 0.88,
        ToggleSlider = Color3.fromRGB(88, 166, 255),
        ToggleToggled = Color3.fromRGB(30, 35, 40),
        SliderRail = Color3.fromRGB(88, 166, 255),
        DropdownFrame = Color3.fromRGB(60, 65, 71),
        DropdownHolder = Color3.fromRGB(39, 44, 50),
        DropdownBorder = Color3.fromRGB(30, 35, 40),
        DropdownOption = Color3.fromRGB(139, 148, 158),
        Keybind = Color3.fromRGB(45, 50, 56),
        Input = Color3.fromRGB(60, 65, 71),
        InputFocused = Color3.fromRGB(25, 30, 35),
        InputIndicator = Color3.fromRGB(110, 116, 124),
        Dialog = Color3.fromRGB(39, 44, 50),
        DialogHolder = Color3.fromRGB(33, 38, 44),
        DialogHolderLine = Color3.fromRGB(30, 35, 40),
        DialogButton = Color3.fromRGB(39, 44, 50),
        DialogButtonBorder = Color3.fromRGB(48, 54, 61),
        DialogBorder = Color3.fromRGB(48, 54, 61),
        DialogInput = Color3.fromRGB(48, 54, 61),
        DialogInputLine = Color3.fromRGB(60, 65, 71),
        Text = Color3.fromRGB(201, 209, 217),
        SubText = Color3.fromRGB(139, 148, 158),
        Hover = Color3.fromRGB(45, 50, 56),
        HoverChange = 0.08
    },
    ["GitHub Light Colorblind"] = {
        Name = "GitHub Light Colorblind",
        Accent = Color3.fromRGB(1, 92, 195),
        AcrylicMain = Color3.fromRGB(246, 248, 250),
        AcrylicBorder = Color3.fromRGB(209, 213, 218),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(246, 248, 250), Color3.fromRGB(246, 248, 250)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(209, 213, 218),
        Tab = Color3.fromRGB(31, 41, 55),
        Element = Color3.fromRGB(243, 244, 246),
        ElementBorder = Color3.fromRGB(209, 213, 218),
        InElementBorder = Color3.fromRGB(209, 213, 218),
        ElementTransparency = 0.85,
        ToggleSlider = Color3.fromRGB(1, 92, 195),
        ToggleToggled = Color3.fromRGB(255, 255, 255),
        SliderRail = Color3.fromRGB(1, 92, 195),
        DropdownFrame = Color3.fromRGB(255, 255, 255),
        DropdownHolder = Color3.fromRGB(246, 248, 250),
        DropdownBorder = Color3.fromRGB(209, 213, 218),
        DropdownOption = Color3.fromRGB(31, 41, 55),
        Keybind = Color3.fromRGB(243, 244, 246),
        Input = Color3.fromRGB(255, 255, 255),
        InputFocused = Color3.fromRGB(255, 255, 255),
        InputIndicator = Color3.fromRGB(101, 116, 134),
        Dialog = Color3.fromRGB(246, 248, 250),
        DialogHolder = Color3.fromRGB(243, 244, 246),
        DialogHolderLine = Color3.fromRGB(209, 213, 218),
        DialogButton = Color3.fromRGB(246, 248, 250),
        DialogButtonBorder = Color3.fromRGB(209, 213, 218),
        DialogBorder = Color3.fromRGB(209, 213, 218),
        DialogInput = Color3.fromRGB(255, 255, 255),
        DialogInputLine = Color3.fromRGB(1, 92, 195),
        Text = Color3.fromRGB(31, 41, 55),
        SubText = Color3.fromRGB(101, 116, 134),
        Hover = Color3.fromRGB(239, 241, 243),
        HoverChange = 0.05
    },
    ["Monokai Dimmed"] = {
        Name = "Monokai Dimmed",
        Accent = Color3.fromRGB(163, 126, 69),
        AcrylicMain = Color3.fromRGB(39, 40, 34),
        AcrylicBorder = Color3.fromRGB(60, 61, 55),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(39, 40, 34), Color3.fromRGB(39, 40, 34)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(50, 51, 45),
        Tab = Color3.fromRGB(117, 113, 94),
        Element = Color3.fromRGB(60, 61, 55),
        ElementBorder = Color3.fromRGB(39, 40, 34),
        InElementBorder = Color3.fromRGB(60, 61, 55),
        ElementTransparency = 0.88,
        ToggleSlider = Color3.fromRGB(163, 126, 69),
        ToggleToggled = Color3.fromRGB(39, 40, 34),
        SliderRail = Color3.fromRGB(163, 126, 69),
        DropdownFrame = Color3.fromRGB(78, 79, 73),
        DropdownHolder = Color3.fromRGB(50, 51, 45),
        DropdownBorder = Color3.fromRGB(39, 40, 34),
        DropdownOption = Color3.fromRGB(117, 113, 94),
        Keybind = Color3.fromRGB(60, 61, 55),
        Input = Color3.fromRGB(78, 79, 73),
        InputFocused = Color3.fromRGB(39, 40, 34),
        InputIndicator = Color3.fromRGB(117, 113, 94),
        Dialog = Color3.fromRGB(50, 51, 45),
        DialogHolder = Color3.fromRGB(39, 40, 34),
        DialogHolderLine = Color3.fromRGB(39, 40, 34),
        DialogButton = Color3.fromRGB(50, 51, 45),
        DialogButtonBorder = Color3.fromRGB(60, 61, 55),
        DialogBorder = Color3.fromRGB(60, 61, 55),
        DialogInput = Color3.fromRGB(60, 61, 55),
        DialogInputLine = Color3.fromRGB(78, 79, 73),
        Text = Color3.fromRGB(171, 178, 191),
        SubText = Color3.fromRGB(117, 113, 94),
        Hover = Color3.fromRGB(60, 61, 55),
        HoverChange = 0.08
    },
    ["GitHub Dark"] = {
        Name = "GitHub Dark",
        Accent = Color3.fromRGB(88, 166, 255),
        AcrylicMain = Color3.fromRGB(36, 41, 46),
        AcrylicBorder = Color3.fromRGB(48, 54, 61),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(36, 41, 46), Color3.fromRGB(36, 41, 46)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(45, 50, 56),
        Tab = Color3.fromRGB(139, 148, 158),
        Element = Color3.fromRGB(48, 54, 61),
        ElementBorder = Color3.fromRGB(36, 41, 46),
        InElementBorder = Color3.fromRGB(48, 54, 61),
        ElementTransparency = 0.88,
        ToggleSlider = Color3.fromRGB(88, 166, 255),
        ToggleToggled = Color3.fromRGB(36, 41, 46),
        SliderRail = Color3.fromRGB(88, 166, 255),
        DropdownFrame = Color3.fromRGB(60, 65, 71),
        DropdownHolder = Color3.fromRGB(45, 50, 56),
        DropdownBorder = Color3.fromRGB(36, 41, 46),
        DropdownOption = Color3.fromRGB(139, 148, 158),
        Keybind = Color3.fromRGB(48, 54, 61),
        Input = Color3.fromRGB(60, 65, 71),
        InputFocused = Color3.fromRGB(36, 41, 46),
        InputIndicator = Color3.fromRGB(110, 116, 124),
        Dialog = Color3.fromRGB(45, 50, 56),
        DialogHolder = Color3.fromRGB(36, 41, 46),
        DialogHolderLine = Color3.fromRGB(36, 41, 46),
        DialogButton = Color3.fromRGB(45, 50, 56),
        DialogButtonBorder = Color3.fromRGB(48, 54, 61),
        DialogBorder = Color3.fromRGB(48, 54, 61),
        DialogInput = Color3.fromRGB(48, 54, 61),
        DialogInputLine = Color3.fromRGB(60, 65, 71),
        Text = Color3.fromRGB(201, 209, 217),
        SubText = Color3.fromRGB(139, 148, 158),
        Hover = Color3.fromRGB(48, 54, 61),
        HoverChange = 0.08
    },
    ["GitHub Light Default"] = {
        Name = "GitHub Light Default",
        Accent = Color3.fromRGB(36, 110, 229),
        AcrylicMain = Color3.fromRGB(255, 255, 255),
        AcrylicBorder = Color3.fromRGB(209, 213, 218),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 255, 255), Color3.fromRGB(255, 255, 255)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(209, 213, 218),
        Tab = Color3.fromRGB(36, 41, 46),
        Element = Color3.fromRGB(246, 248, 250),
        ElementBorder = Color3.fromRGB(209, 213, 218),
        InElementBorder = Color3.fromRGB(209, 213, 218),
        ElementTransparency = 0.85,
        ToggleSlider = Color3.fromRGB(36, 110, 229),
        ToggleToggled = Color3.fromRGB(255, 255, 255),
        SliderRail = Color3.fromRGB(36, 110, 229),
        DropdownFrame = Color3.fromRGB(255, 255, 255),
        DropdownHolder = Color3.fromRGB(246, 248, 250),
        DropdownBorder = Color3.fromRGB(209, 213, 218),
        DropdownOption = Color3.fromRGB(36, 41, 46),
        Keybind = Color3.fromRGB(246, 248, 250),
        Input = Color3.fromRGB(255, 255, 255),
        InputFocused = Color3.fromRGB(255, 255, 255),
        InputIndicator = Color3.fromRGB(106, 115, 125),
        Dialog = Color3.fromRGB(246, 248, 250),
        DialogHolder = Color3.fromRGB(246, 248, 250),
        DialogHolderLine = Color3.fromRGB(209, 213, 218),
        DialogButton = Color3.fromRGB(246, 248, 250),
        DialogButtonBorder = Color3.fromRGB(209, 213, 218),
        DialogBorder = Color3.fromRGB(209, 213, 218),
        DialogInput = Color3.fromRGB(255, 255, 255),
        DialogInputLine = Color3.fromRGB(36, 110, 229),
        Text = Color3.fromRGB(36, 41, 46),
        SubText = Color3.fromRGB(106, 115, 125),
        Hover = Color3.fromRGB(243, 244, 246),
        HoverChange = 0.05
    },
    ["GitHub Light High Contrast"] = {
        Name = "GitHub Light High Contrast",
        Accent = Color3.fromRGB(0, 103, 209),
        AcrylicMain = Color3.fromRGB(255, 255, 255),
        AcrylicBorder = Color3.fromRGB(171, 178, 191),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 255, 255), Color3.fromRGB(255, 255, 255)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(171, 178, 191),
        Tab = Color3.fromRGB(31, 41, 55),
        Element = Color3.fromRGB(243, 244, 246),
        ElementBorder = Color3.fromRGB(171, 178, 191),
        InElementBorder = Color3.fromRGB(171, 178, 191),
        ElementTransparency = 0.85,
        ToggleSlider = Color3.fromRGB(0, 103, 209),
        ToggleToggled = Color3.fromRGB(255, 255, 255),
        SliderRail = Color3.fromRGB(0, 103, 209),
        DropdownFrame = Color3.fromRGB(255, 255, 255),
        DropdownHolder = Color3.fromRGB(243, 244, 246),
        DropdownBorder = Color3.fromRGB(171, 178, 191),
        DropdownOption = Color3.fromRGB(31, 41, 55),
        Keybind = Color3.fromRGB(243, 244, 246),
        Input = Color3.fromRGB(255, 255, 255),
        InputFocused = Color3.fromRGB(255, 255, 255),
        InputIndicator = Color3.fromRGB(87, 96, 106),
        Dialog = Color3.fromRGB(243, 244, 246),
        DialogHolder = Color3.fromRGB(243, 244, 246),
        DialogHolderLine = Color3.fromRGB(171, 178, 191),
        DialogButton = Color3.fromRGB(243, 244, 246),
        DialogButtonBorder = Color3.fromRGB(171, 178, 191),
        DialogBorder = Color3.fromRGB(171, 178, 191),
        DialogInput = Color3.fromRGB(255, 255, 255),
        DialogInputLine = Color3.fromRGB(0, 103, 209),
        Text = Color3.fromRGB(31, 41, 55),
        SubText = Color3.fromRGB(87, 96, 106),
        Hover = Color3.fromRGB(239, 241, 243),
        HoverChange = 0.05
    },
    ["GitHub Dark High Contrast"] = {
        ...
        Accent = Color3.fromRGB(88, 166, 255),
        AcrylicMain = Color3.fromRGB(12, 17, 23),
        AcrylicBorder = Color3.fromRGB(48, 54, 61),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(12, 17, 23), Color3.fromRGB(12, 17, 23)),
        AcrylicNoise = 0.9,
        TitleBarLine = Color3.fromRGB(36, 41, 46),
        Tab = Color3.fromRGB(171, 178, 191),
        Element = Color3.fromRGB(36, 41, 46),
        ElementBorder = Color3.fromRGB(12, 17, 23),
        InElementBorder = Color3.fromRGB(48, 54, 61),
        ElementTransparency = 0.89,
        ToggleSlider = Color3.fromRGB(88, 166, 255),
        ToggleToggled = Color3.fromRGB(12, 17, 23),
        SliderRail = Color3.fromRGB(88, 166, 255),
        DropdownFrame = Color3.fromRGB(48, 54, 61),
        DropdownHolder = Color3.fromRGB(36, 41, 46),
        DropdownBorder = Color3.fromRGB(12, 17, 23),
        DropdownOption = Color3.fromRGB(171, 178, 191),
        Keybind = Color3.fromRGB(36, 41, 46),
        Input = Color3.fromRGB(48, 54, 61),
        InputFocused = Color3.fromRGB(12, 17, 23),
        InputIndicator = Color3.fromRGB(139, 148, 158),
        Dialog = Color3.fromRGB(36, 41, 46),
        DialogHolder = Color3.fromRGB(12, 17, 23),
        DialogHolderLine = Color3.fromRGB(12, 17, 23),
        DialogButton = Color3.fromRGB(36, 41, 46),
        DialogButtonBorder = Color3.fromRGB(48, 54, 61),
        DialogBorder = Color3.fromRGB(48, 54, 61),
        DialogInput = Color3.fromRGB(48, 54, 61),
        DialogInputLine = Color3.fromRGB(48, 54, 61),
        Text = Color3.fromRGB(230, 237, 243),
        SubText = Color3.fromRGB(139, 148, 158),
        Hover = Color3.fromRGB(36, 41, 46),
        HoverChange = 0.09
    },
